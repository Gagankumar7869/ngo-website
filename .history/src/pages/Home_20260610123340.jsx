...
export default function Home() {
  ...
  // --- FRONTEND PDF GENERATOR (MATCHING PHYSICAL RECEIPT) ---
  const handleClaimSubmit = (e) => {
    e.preventDefault();
    
    try {
      // 1. Create a custom-sized landscape PDF (like a physical receipt slip)
      // 210mm wide by 120mm tall
      const doc = new jsPDF({
      ...
      doc.text("ABHA SEVA SADAN", 110, 20, { align: "center" });
      ...
      doc.setFontSize(10);
      doc.text("Regd No. - 1956/4/3864-2006", 110, 34, { align: "center" });
      doc.text("Gargadbahal, Jujomura, Sambalpur-768105", 110, 40, { align: "center" });

      // 3. Draw an optional border around the whole receipt
      ...
      doc.line(144, 101, 205, 101);

      // Line 4: Account Detail
      doc.setFont("helvetica", "bold");
      ...
      // 8. Download the PDF
      doc.save(`Abha_Seva_Sadan_Receipt_${formData.donorName}.pdf`);
