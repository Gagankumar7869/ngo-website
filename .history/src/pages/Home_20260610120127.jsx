...
export default function Home() {
  ...
  return (
    <div className="home-container">
      ...
      {/* 1. HERO SECTION (Now with image overlay) */}
      ...
      {/* 2. OUR INITIATIVES (New Section with Icons) */}
      ...
      {/* 3. DONATION HUB (Using new glassmorphism effect) */}
