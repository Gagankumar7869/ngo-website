...
export default function Home() {
  ...
  // Added 'fundSelect' to determine which receipt to generate
  const [formData, setFormData] = useState({
    donorName: '',
    email: '',
    amount: '',
    utrNumber: '',
    fundSelect: 'Abha Seva Sadan' // Default option
  });
  ...
  const handleClaimSubmit = (e) => {
    ...
    try {
      ...
      // 1. Create a custom-sized landscape PDF (like a physical receipt slip)
      const doc = new jsPDF({
      ...
      // 2. Add Official Headers (Centered)
      doc.setFont("helvetica", "bold");
      doc.setFontSize(24);
      doc.setTextColor(80, 80, 80); // Dark gray to mimic ink
      ...
      // 3. Draw a border around the whole receipt
      doc.setLineWidth(0.5);
      doc.setDrawColor(100, 100, 100);
      doc.rect(5, 5, 210, 120);

      // 4. Sl.No and Date row
      doc.setFontSize(12);
      const randomSlNo = Math.floor(Math.random() * 1000) + 118; // Generates a random slip number
      ...
      // 5. Main Receipt Body Lines
      doc.setFont("helvetica", "normal");
      
      // Line 1: Name (Same for both)
      doc.text("Received with thanks from Mr/Mrs/Ms.", 15, 70);
      doc.setFont("helvetica", "bold");
      doc.text(formData.donorName, 90, 69); // Prints name just above the line
      doc.setLineWidth(0.2);
      doc.line(88, 71, 205, 71); // Draws the underline

      // Line 2: Amount (Same for both)
      doc.setFont("helvetica", "normal");
      ...
      // 6. Conditional Payment Details & Account Line
      if (isGurukul) {
        // GURUKUL LAYOUT
        doc.setFont("helvetica", "normal");
        ...
        // Account Detail is on a new line for Abha
        doc.setFont("helvetica", "bold");
        doc.text("on account of ABHA SEVA SADAN.", 15, 110);
      }

      // 7. Bottom Rs. Box
      doc.setFillColor(60, 60, 60); // Dark filled box
      doc.rect(15, 115, 20, 10, "F");
      doc.setTextColor(255, 255, 255);
      doc.text("Rs.", 18, 122);
      
      // Empty white box for the number
        ...
        <div className="row g-4 align-items-stretch">
          ...
          <div className="col-md-6">
            <div className="premium-card h-100 p-4 p-md-5" style={{ borderLeft: '5px solid var(--accent-coral)' }}>
              ...
              <p className="text-muted mb-0" style={{ lineHeight: '1.8' }}>
                Beyond standard academics, we focus heavily on value-based education, essential life skills, and holistic physical development. Our goal is to empower these children to break the cycle of poverty and build a brighter future.
              </p>
            </div>
          </div>
          ...
          <div className="col-md-6">
            <div className="premium-card h-100 p-4 p-md-5" style={{ borderLeft: '5px solid var(--primary-blue)' }}>
              ...
              <p className="text-muted mb-0" style={{ lineHeight: '1.8' }}>
                Operating with a spirit of service, our medical camps and daily clinics ensure that basic healthcare remains a fundamental human right. We provide essential medicines, expert consultations, and emergency support.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="row g-4 align-items-stretch">
          ...
          <div className="col-md-4">
            <div className="glass-card h-100 text-center p-4">
              ...
              <div className="bg-white p-3 rounded-4 mb-3 d-inline-block shadow-sm">
          ...
          {/* Bank Details */}
          <div className="col-md-4">
            <div className="glass-card h-100 p-4" style={{ borderTop: '5px solid var(--accent-coral)' }}>
              <h5 className="fw-bold mb-4" style={{ color: 'var(--primary-blue)' }}>Direct Bank Transfer</h5>
              <div className="mb-3 border-bottom pb-2 border-secondary border-opacity-25">
